...
class ArrivalRateSchedule:
    ...
    def __init__(self):
        ...
        # SLOWED DOWN: Reduced rates by 80% for better observation
        self.schedule = [
            (9, 11, self._linear_ramp(2, 6)),     # Morning ramp-up (was 10-30)
            (11, 13, lambda h: 12),                # Lunch rush (was 60)
            (13, 15, self._linear_ramp(12, 4)),    # Post-lunch decline (was 60-20)
            (15, 17, lambda h: 3),                 # Late afternoon (was 15)
        ]
        
        # Default rate for hours outside schedule
        self.default_rate = 1  # Was 5
